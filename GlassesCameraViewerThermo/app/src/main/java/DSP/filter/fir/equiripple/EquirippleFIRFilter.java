...
abstract class EquirippleFIRFilter {
  ...
  public    void       generateCoefficients() {
    ...
    System.out.println("COEFFICIENTS: SIZE:  "+coefficients.length+", VALUES: "+Arrays.toString(coefficients));
  }
   ...
   * @return        double[] containing the resulting filtered sequence.
   */
  public    double[]    filterSize( double[] x ) {
    ...
    System.arraycopy( tmp, 0, kernel, 0, x.length );
